    ...
    if ($id > 0) {
        if ($_POST['action'] === 'delete') {
            ...
            if ($row && !empty($row['featured_image'])) {
                upload_delete_image($row['featured_image']);
            }
...
$rows = $pdo->query('SELECT * FROM blogs ORDER BY created_at DESC')->fetchAll();
...
<head>
    <meta charset="utf-8">
    <title>Blogs - Travisa Admin</title>
        ...
        <div class="row">
            ...
            <main class="col-md-10 py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="blog-edit.php" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i> Add Blog</a>
                </div>
                <?php if ($flash): ?>
                            ...
                            <tbody>
                                <?php foreach ($rows as $r): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="blog-edit.php?id=<?= (int) $r['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                ...
                                <?php endforeach; ?>
                                <?php if (empty($rows)): ?>
                                    <tr><td colspan="6" class="text-center text-muted py-4">No blogs yet. <a href="blog-edit.php">Add one</a>.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
